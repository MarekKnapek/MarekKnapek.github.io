...
function float_on_changed(bit, idx)
{
	...
	const one_buf = float_g.wi.exports.memory.buffer.slice(analyzer + one_off, analyzer + one_off + 1); const one_val = new Uint8Array(one_buf); console.assert(one_val == 0 || one_val == 1); const one_str = one_val == 0 ? "No" : "Yes";
