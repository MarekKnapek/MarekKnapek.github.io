...
function float_on_changed(bit, idx)
{
	...
	const analyzer = g_analyzer.wi.exports.float_analyzer_analyze(g_analyzer.arr[0], g_analyzer.arr[1], g_analyzer.arr[2], g_analyzer.arr[3]);
...
function float_make_checkboxes()
{
	const bits_all = 32;
	const bits_mts = 23;
