...
function double_on_changed(bit, idx)
{
	...
	const analyzer = g_analyzer.wi.exports.double_analyzer_analyze(g_analyzer.arr[0], g_analyzer.arr[1], g_analyzer.arr[2], g_analyzer.arr[3], g_analyzer.arr[4], g_analyzer.arr[5], g_analyzer.arr[6], g_analyzer.arr[7]);
...
function double_parse_url()
{
	...
	)
	{
		...
		for(let i = 0; i != bits_cnt; ++i)
		{
			...
			double_on_changed(document.getElementById("bit" + i), i);
		}
	}
}
